...
void ILI9341_drawDotLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t space, uint16_t color) {
...
void ILI9341_fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
  ...
  *(lcd_cs)= 0;
  ...
  for(y=h; y>0; y--) {
    for(x=w; x>0; x--) {
    //soft_spi_1_write(color>>8);
    //soft_spi_1_write(color);
    soft_spi_1_wr16(color);
    }
  }
  *(lcd_cs)= 1;
