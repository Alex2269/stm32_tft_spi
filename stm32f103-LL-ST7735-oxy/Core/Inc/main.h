...
#define PWMVGND_Pin LL_GPIO_PIN_0
#define PWMVGND_GPIO_Port GPIOB
#define PWMPUMP_Pin LL_GPIO_PIN_1
#define PWMPUMP_GPIO_Port GPIOB
#define LCD_LED_Pin LL_GPIO_PIN_4
